...
def main():
    ...
    name = "Luis" # TODO: Insert your name between the double quotes

    print(f"{name}, Welcome to the CSS course!")
    print(f"{name},Hello everyone, I am junior from Indiana. I enjoy building arduino projects. My friends and I are currently working on building a go kart. ")
